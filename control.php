...
if (isset($_POST["start_game"])) {
    ...
    file_put_contents($securePath . "/runner_snapshot.json", json_encode(null));
    file_put_contents($securePath . "/hunter_snapshot.json", json_encode(null));
...
<small>Dauer einer Spielrunde</small>
...
<small>Vorsprung der Gejagten vor Jagdbeginn</small>
...
<small>Intervall für Joker-Positionen</small>
